...
@SlingServlet(extensions = { "json" }, selectors = { "list" }, methods = { "GET" }, resourceTypes = { "godswill/book" }, metatype = false)
public class BookServlet extends SlingSafeMethodsServlet {
	...
	protected void doGet(SlingHttpServletRequest request,
			...
			IOException {
		Book book = request.getResource().adaptTo(Book.class);
